...
interface AddSurfboardModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export function AddSurfboardModal({ isOpen, onClose }: AddSurfboardModalProps) {
    ...
    <>
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>List Your Surfboard</DialogTitle>
            <DialogDescription>
              Fill out the details below to list your surfboard for rent.
            </DialogDescription>
          </DialogHeader>
